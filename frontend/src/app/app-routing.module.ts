...
const routes: Routes = [
  { path: '', redirectTo: 'home', pathMatch: 'full' },
  {
    ...
    children: [
      ...
      { path: 'contributors', component: UserManagementComponent },
      { path: 'security', component: SecurityComponent },
      { path: 'items', component: ItemsMangementComponent },
      { path: 'detail-hist/:user-id', component: UserChangeHistoryComponent },
      { path: 'users', component: AdminUserManageComponent, canActivate: [AdminGuard] },
