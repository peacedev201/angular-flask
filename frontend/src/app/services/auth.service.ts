...
export class AuthService {
  ...
  login(useremail: string, pwd: string) {
    console.log("this is test",useremail, pwd)
  ...
  registerUser(useremail: string, username: string, pwd: string) {
  ...
  public isAdminUser() {
    const currentUser = this.currentUserValue;
    return (currentUser && currentUser.role && currentUser.role === 'admin') ? true : false;
  }
}
